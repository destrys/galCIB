...
class Cosmology:
    ...
    # def _calculate_prop(self):
    #     """
    #     Returns most used relevant cosmological properties 
    #     that are used for C_ell and Pk calculations.
