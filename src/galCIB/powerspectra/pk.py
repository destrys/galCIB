...
class PkBuilder:
    def __init__(self, hod_model, cib_model, gal_prof_model, cib_prof_model,
        ...
        self.hmfxbias = self.hmf * self.gal_prof_model.bnu #FIXME: bias model choice, do we care if galaxy or CIB?
    ...
    def _cache_cib_integral(self):
        ...
        self.djsub_u = self.djsub * cib_u[None,:,:,:] # useful in multiple places in Pk
    ...
    def _update_theta(self, theta_cen, theta_sat, theta_gal_prof, theta_cib_prof,
    ...
    def compute_pk(self, theta_cen=None, theta_sat=None, theta_gal_prof=None,
                   theta_cib_prof=None,
        ...
        self._update_theta(theta_cen, theta_sat, theta_gal_prof, theta_cib_prof,
                           theta_sfr, theta_snu, theta_IR_hod)
